...
Reference benchmarks from mmnto-ai/totem-strategy#73 (438-lesson sample): Sonnet 4.6 produced 90% structurally-correct rules at 2.4 seconds per lesson; Gemini Pro produced 73% at 19.6 seconds per lesson. The local-Sonnet path is the basis for the curated rule set the project ships today (<!-- docs RULE_COUNT -->485<!-- /docs --> compiled rules, <!-- docs ACTIVE_RULE_COUNT -->385<!-- /docs --> of them active, the rest archived, untested against the codebase or pending verification).
