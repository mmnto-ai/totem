...
- **Methodology invariants held.** Zero blanket closures. Zero archive decisions without explicit user approval. Gemini pushback on B8c and orphan-proposal aggression was declined on methodology grounds and conceded in subsequent rounds.
