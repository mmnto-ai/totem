...
- **Setup & Infrastructure:**
  ...
  - **Environment Support:** Package manager auto-detection fully supports Bun and safely detects non-bash environments (#421, #316). Command modules leverage top-level dynamic imports to significantly boost CLI startup performance (#594). The system is hardened by a portability audit for the 1.0 release, ensuring execution stability across Ubuntu, Windows, and macOS environments (#774, #638).
