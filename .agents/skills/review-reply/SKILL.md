...
- **ghcq items:** `github-code-quality[bot]` has NO @-listener (mmnto-ai/totem#2626) — never tag it, and expect no response to replies; its dispositions are audit-trail-only.
