...
| ------------------------------- | ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `@mmnto/cli`                    | `>=24`       | Matches the CI runner pin set in [`mmnto-ai/totem#1991`](https://github.com/mmnto-ai/totem/pull/1991) (Node 22 → 24 to ship bundled npm 11.x natively for OIDC publishing) |
