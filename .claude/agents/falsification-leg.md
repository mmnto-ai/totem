...
- Return findings numbered (`F1`, `F2`, …) and ranked BLOCKING · MATERIAL · MINOR · QUESTION (model-tiering § Typed deposits names the first three; QUESTION is the cohort's practice and, since mmnto-ai/totem#2944, the deposit mechanism's fourth class — a question for the seat, answered, and marked folded once answered; the ids let the seat's deposit under § The gate name what it folded), each as a typed deposit: claim · primary source quoted · assertion strength · verdict.
