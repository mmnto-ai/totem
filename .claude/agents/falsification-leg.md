...
- Return findings numbered (`F1`, `F2`, …) and ranked BLOCKING · MATERIAL · MINOR · QUESTION (model-tiering § Typed deposits — the ids let the seat's deposit under § The gate name what it folded; a QUESTION is a question for the seat, answered rather than folded, and `totem legs deposit` counts it beside the three since mmnto-ai/totem#2944), each as a typed deposit: claim · primary source quoted · assertion strength · verdict.
