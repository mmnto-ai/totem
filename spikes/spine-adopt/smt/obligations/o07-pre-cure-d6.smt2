...
; D6 PRE-CURE SPECIMEN: the logically redundant alphabet-membership guard whose
; presence moved cvc5 from 34ms sat to undecided at a 300s budget (z3 indifferent).
; Replay: z3 -smt2 <this file>  vs  cvc5 --lang smt2 --tlimit=300000 <this file>
(assert (str.in_re s (re.* (re.union (str.to_re "\u{9}") (re.range " " "~")))))
