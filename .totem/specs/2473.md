...
- Fan execution is structurally unreachable on a not-applicable admission (type-level: the fan takes the admitted variant); incremental narrowing operates only inside the admitted branch.
