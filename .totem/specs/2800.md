...
- [ ] **Task 1: Define Schemas & GateVerdict Types**
  ...
  *Files to modify:* `packages/core/src/types/gate.ts`
  *Test files to create:* `packages/core/src/types/gate.test.ts`
...
- [ ] **Task 2: Build Deterministic Predicate Evaluator Engine**
  ...
  *Files to modify:* `packages/cli/src/commands/gate-check-evaluator.ts` (New file)
  *Test files to create:* `packages/cli/src/commands/gate-check-evaluator.test.ts`
...
- [ ] **Task 3: Integrate `--pilot` and `--tier` Flags in Gate CLI Verb**
  ...
  *Files to modify:* `packages/cli/src/commands/gate-check.ts`
  *Test files to update:* `packages/cli/src/commands/gate-check.test.ts`
...
- [ ] **Task 4: Write Matcher & Hook Registrar**
  ...
  *Files to modify:* `packages/cli/src/commands/gate-install.ts`, `packages/cli/src/commands/init.ts`
  *Test files to update:* `packages/cli/src/commands/gate-install.test.ts`
