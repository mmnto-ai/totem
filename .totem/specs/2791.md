...
- Color compares case-insensitively without `#` (normalized on both the canon and the live side); description compares exactly, untrimmed, as the twin does; a `null` description against canonical text is a redefinition.
