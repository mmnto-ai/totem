...
| 5628da37 | issue | 6953 | 6 | 2 | 2 | 9 | 6 | 2 | 0 | 0 | 0 | 2 | 0.267 |
...
| 940ec4c9 | issue | 8920 | 8 | 2 | 1 | 9 | 5 | 2 | 0 | 0 | 0 | 5 | 0.176 |
...
| 0426a34a | issue | 6899 | 6 | 1 | 1 | 7 | 2 | 0 | 0 | 0 | 0 | 0 | 0.077 |
...
| 0eb7c23c | issue | 9824 | 9 | 4 | 0 | 7 | 0 | 0 | 1 | 1 | 1 | 0 | 0.059 |
| be5140ac | issue | 7906 | 5 | 0 | 0 | 12 | 5 | 1 | 0 | 0 | 0 | 0 | 0.059 |
...
| 518e6de3 | topic | 5512 | 4 | 0 | 0 | 5 | 0 | 0 | 0 | 0 | 0 | 0 | 0.000 |
...
Totals: paths named 264, missing 111, missing-not-proposed 64; idents named 536, missing 195, missing-not-proposed 61; flags named 31, missing 9, missing-not-proposed 5; issue refs 48.
...
| path | `.totem/spine/gate-1/windtunnel.lock.json` | 1 |
| path | `.totem/verification-outcomes.json` | 1 |
| path | `@mmnto/strategy-doctrine/package.json` | 1 |
...
| ident | `checkpointFiles` | 1 |
| ident | `CI_COMMIT_BRANCH` | 1 |
| ident | `CollisionType` | 1 |
| ident | `CONTROL_PLANE_PATTERNS` | 1 |
