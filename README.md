...
- [**Maturity:**](https://github.com/mmnto-ai/totem/blob/main/docs/wiki/maturity.md) What's shipped, partial, and still a goal — machine-derived rows with receipts, drift-gated in CI.
