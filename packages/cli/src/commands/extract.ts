...
---LESSON---
Heading: Provide a 3-7 word title summarizing the rule as a complete phrase (e.g., "Always sanitize Git outputs", "Guard reversed marker ordering"). Must NOT be a sentence fragment or truncated text.
Tags: tag1, tag2, tag3
