...
// of utils so constants like `IS_WIN`/`GH_TIMEOUT_MS` stay accessible.
// Per Sonnet review of CR R2: dropping the spread is fragile to future
// drift in the dependency graph.
