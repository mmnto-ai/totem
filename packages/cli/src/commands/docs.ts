...
- **Empty Context Safety:** If the active_work context is empty, state that no active work is currently planned rather than deleting roadmap sections entirely.
