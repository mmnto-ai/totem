...
const mailCmd = program
  ...
  .addHelpText(
    ...
    [
      ...
      '',
      "Each unread item carries a `read:` line — the dispatch's absolute path, the",
      'same `filePath` the --json output emits (mmnto-ai/totem#2919). Open it',
      "there and pass it to `totem mail mark`; never list a sender's outbox to find",
      "a file — it holds every seat's dispatches.",
      '',
