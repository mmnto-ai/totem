...
mmnto-ai/totem#2844) and the ten mmnto-ai/totem#2861 rows (`2026-09-16T00:47:11.787Z` —
eight new and the negative control re-authored; the window pair and the negative control
re-authored again at `2026-09-16T01:17:05.889Z` for the fold that added the disposition
line) at the end of the table. Each covers an invariant the captures cannot.
...
| `synthetic-head-commit-high-inline.json`                  | 2861 — the NEGATIVE CONTROL, field shape: a bare-resolved HIGH on head still denies under later human chatter          | `b80e37943afdf82593f0376a42f103d0ca706f18ed9df4fadaa6b92a2d003f94` |
...
| `synthetic-high-inline-discharged-window-incomplete.json` | 2861 — evidence FOUND discharges even when the thread window is incomplete                                             | `5d21714b174eaed8f1dee951072fb9da1ddfcedcc35577a1331cf6000ace9335` |
